...
document.addEventListener('DOMContentLoaded', function() {
    const getUserDraftBtn = document.getElementById('getUserDraftBtn');
    const sendWithAIBtn = document.getElementById('sendWithAIBtn');
    ...
    getUserDraftBtn.addEventListener('click', function() {
    ...
    sendWithAIBtn.addEventListener('click', function() {
        chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
